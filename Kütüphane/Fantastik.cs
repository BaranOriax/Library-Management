...
namespace Kütüphane
{
    public partial class Fantastik : Form
    {
        ...
        private void Fantastik_Load(object sender, EventArgs e)
        {
            verileriYukle();
        ...
        public void verileriYukle()
        {
            try
            {
                string query = "SELECT kitapAdı FROM Kitaplar WHERE tür = 'Fantastik'";
